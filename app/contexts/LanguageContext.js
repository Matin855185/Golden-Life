...
const translations = {
  fa: {
    ...
    'technician_registration': 'ثبت‌نام تکنسین، متخصص خدمات',
    'earn_per_hour': 'با هر ساعت کار درآمد کسب کنید!',
    'join_platform': 'به بزرگترین پلتفرم خدمات منزل بپیوندید و با ارائه خدمات تخصصی، درآمد پایدار کسب کنید',
    'start_registration': 'شروع ثبت‌نام',
    'select_specialization': 'انتخاب تخصص خود',
    'calculate_income': 'با انتخاب هر تخصص می‌توانید درآمد تقریبی خود را محاسبه کنید',
    'income_calculator': 'محاسبه درآمد',
    'select_daily_hours': 'ساعات کاری روزانه خود را انتخاب کنید',
    'hours': 'ساعات',
    'monthly_income': 'درآمد تقریبی ماهانه:',
    'toman': 'تومان',
    'calculation_note': 'محاسبه بر اساس 25 روز کاری در ماه',
    'personal_info': 'اطلاعات شخصی',
    'fill_form_carefully': 'فرم زیر را با دقت تکمیل کنید',
    'full_name_required': 'نام و نام خانوادگی *',
    'phone_required': 'شماره تماس *',
    'email_required': 'ایمیل *',
    'experience_required': 'سابقه کار *',
    'working_areas_required': 'مناطق کاری *',
    'enter_full_name_placeholder': 'نام کامل خود را وارد کنید',
    'enter_phone_placeholder': '09123456789',
    'enter_email_placeholder': 'example@email.com',
    'select_experience': 'انتخاب کنید',
    'experience_1_2': '1-2 سال',
    'experience_3_5': '3-5 سال',
    'experience_6_10': '6-10 سال',
    'experience_10_plus': 'بیش از 10 سال',
    'working_areas_placeholder': 'مناطق شهری که می‌توانید در آن‌ها خدمات ارائه دهید',
    'submit_request': 'ارسال درخواست',
    'submitting': 'در حال ارسال...',
    'request_sent': 'درخواست شما با موفقیت ارسال شد',
    'request_review': 'درخواست ثبت‌نام شما در حال بررسی است. پس از تأیید مدارک، تیم ما با شما تماس خواهد گرفت.',
    'golden_life_benefits': 'مزایای همکاری با Golden Life',
    'stable_income': 'درآمد ثابت و کمیسیون رقابتی',
    'insurance_coverage': 'بیمه و پوشش حقوقی کامل',
    'continuous_training': 'آموزش‌های مداوم و به‌روزرسانی',
    'technical_support': 'پشتیبانی فنی و بازاریابی',
    'multi_area_work': 'امکان کار در چندین منطقه',
    'flexible_schedule': 'برنامه‌ریزی انعطاف‌پذیر',
    
    // Services
    'plumbing_service': 'لوله‌کشی و تاسیسات',
    'electrical_service': 'برق و الکترونیک',
    'hvac_service': 'تهویه و کولر',
    'cleaning_service_tech': 'نظافت و خدمات',
    'gardening_service_tech': 'باغبانی',
    'security_service_tech': 'امنیت و نگهبانی',
    'plumbing_desc': 'تعمیر و نصب لوله‌کشی، شیرآلات',
    'electrical_desc': 'نصب و تعمیر تجهیزات برقی',
    'hvac_desc': 'نصب و سرویس کولر و پکیج',
    'cleaning_desc': 'نظافت منزل و محل کار',
    'gardening_desc': 'نگهداری فضای سبز و باغچه',
    'security_desc': 'خدمات امنیتی و نگهبانی',
    'per_hour': 'تومان/ساعت',
  ...
  en: {
    ...
    // Technician Registration
    'technician_registration': 'Technician Registration, Service Specialist',
    'earn_per_hour': 'Earn income with every hour of work!',
    'join_platform': 'Join the largest home services platform and earn stable income by providing specialized services',
    'start_registration': 'Start Registration',
    'select_specialization': 'Select Your Specialization',
    'calculate_income': 'You can calculate your approximate income by selecting any specialization',
    'income_calculator': 'Income Calculator',
    'select_daily_hours': 'Select your daily working hours',
    'hours': 'Hours',
    'monthly_income': 'Approximate Monthly Income:',
    'toman': 'Toman',
    'calculation_note': 'Calculation based on 25 working days per month',
    'personal_info': 'Personal Information',
    'fill_form_carefully': 'Please fill out the form below carefully',
    'full_name_required': 'Full Name *',
    'phone_required': 'Phone Number *',
    'email_required': 'Email *',
    'experience_required': 'Work Experience *',
    'working_areas_required': 'Working Areas *',
    ...
    'experience_10_plus': 'More than 10 years',
    'working_areas_placeholder': 'Urban areas where you can provide services',
    'submit_request': 'Submit Request',
    'submitting': 'Submitting...',
    'request_sent': 'Your request has been successfully submitted',
    'request_review': 'Your registration request is under review. After document verification, our team will contact you.',
    'golden_life_benefits': 'Benefits of Collaborating with Golden Life',
    'stable_income': 'Stable income and competitive commission',
    'insurance_coverage': 'Complete insurance and legal coverage',
    'continuous_training': 'Continuous training and updates',
    'technical_support': 'Technical and marketing support',
    'multi_area_work': 'Ability to work in multiple areas',
    'flexible_schedule': 'Flexible scheduling',
    
    // Services
    'plumbing_service': 'Plumbing & Installations',
    'electrical_service': 'Electrical & Electronics',
    'hvac_service': 'HVAC & Cooling',
    'cleaning_service_tech': 'Cleaning & Services',
    'gardening_service_tech': 'Gardening',
    'security_service_tech': 'Security & Guard',
    'plumbing_desc': 'Repair and installation of plumbing, faucets',
    'electrical_desc': 'Installation and repair of electrical equipment',
    'hvac_desc': 'Installation and service of AC and packages',
    'cleaning_desc': 'Home and workplace cleaning',
    'gardening_desc': 'Green space and garden maintenance',
    'security_desc': 'Security and guard services',
    'per_hour': 'Toman/hour',
